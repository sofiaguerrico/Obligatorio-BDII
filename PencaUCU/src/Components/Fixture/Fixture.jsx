...
const Fixture = () => {
  ...
  const equipos = [
    ...
    { nombre: 'Brasil', bandera: flags.brazil },
    { nombre: 'Canada', bandera: flags.canada },
    ...
    { nombre: 'Mexico', bandera: flags.mexico },
    { nombre: 'Panama', bandera: flags.panama },
    { nombre: 'Paraguay', bandera: flags.paraguay },
    { nombre: 'Perú', bandera: flags.peru },
